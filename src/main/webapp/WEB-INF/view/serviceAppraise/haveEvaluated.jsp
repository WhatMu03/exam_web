        ...
        <div class="remain-evaluated-Padding boxS">
            ...
            <c:forEach items="${list}" varStatus="i" var="item">
                ...
                <div class="evaluate-number">
                    <em>${item.appraiseObj}编号<span class="appraiseObjNo">${item.appraiseObjNo}</span><span>${item.createTime}</span></em>
                </div>
                <div class="displayF">
                    ...
                    <div class="evaluate-btn">
                        <div>
                            <button class="btn btn-primary appraise">再次评价</button>
                        </div>
                    </div>
                </div>
                </div>
    ...
    $(function () {
        ...
        Page({
            ...
            callback:function(n){	//回调函数 
            	window.location.href = "../serviceAppraise/haveEvaluated.html?page=" + n;
            }
        });
        // 分页end
