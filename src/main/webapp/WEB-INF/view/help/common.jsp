...
<head>
    ...
    <title>常见问题_帮助中心_云英客服自助系统</title>
</head>
<body>
    ...
    <div class="clearfix register-main boxS">
        <div class="help-center">
            ...
            <ul>
                ...
                <li class="current" style="cursor:pointer" id="common"><i class="icon iconfont icon-bangzhuzhongxin-3"></i>常见问题</li>
            </ul>
        </div>
	                ...
	                <div class="required-solved hot-unscramble article" style="cursor:pointer">
	                    ...
	                    <div class="clearfix">
	                        <div class="float_left required-number">
	                            <span>${item.title}<i class="icon iconfont icon-changjianwenti"></i></span>
	                        </div>
