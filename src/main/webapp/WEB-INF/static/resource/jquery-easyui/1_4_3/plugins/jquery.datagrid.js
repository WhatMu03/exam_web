...
var _2vwh=_2vw.children("div.datagrid-header");

var _30=_2e.find("table");
var _31=_2f.find("table");
var _2vwtable=_2vwh.find("table");


_2b.width(_29);

var _32=_2e.children("div.datagrid-header-inner").show();
var _2vww=_2vwh.children("div.datagrid-header-inner").show();



_2c.width(_32.find("table").width());
_2vw.width(_2vww.find("table").width());
...
_2d.width(_29-_2c._outerWidth()-_2vw._outerWidth()).css("left",_2vw._outerWidth());
//_2d.width(_29-_2c._outerWidth()-_2vw._outerWidth()).css("right",_2vw._outerWidth());//锁定左列


if(_31.width()<=_29-_2c._outerWidth()-_2vw._outerWidth()){
	_2d.addClass('grid-short-table')
}else{
	_2d.removeClass('grid-short-table')
}


_2c.children()._outerWidth(_2c.width());
_2d.children()._outerWidth(_2d.width());
_2vw.children()._outerWidth(_2vw.width());


var all=_2e.add(_2f).add(_2vwh).add(_30).add(_31).add(_2vwtable);
all.css("height","");
var hh=Math.max(_30.height(),_31.height());
all._outerHeight(hh);

dc.body1.add(dc.body2).add(dc.body3).children("table.datagrid-btable-frozen").css({position:"absolute",top:dc.header2._outerHeight()});
...
_2c.add(_2d).add(_2vw).children("div.datagrid-body").css({marginTop:_33,height:(isNaN(parseInt(_27.height))?"":(_2a-_34)),minHeight:(_36?_36-_35-_34:""),maxHeight:(_37?_37-_35-_34:"")});
...
tr2.css("height","");
tr3.css("height","");
var _x46=Math.max.apply(this,[tr1.height(),tr2.height(),tr3.height()]);
tr1.css("height",_x46);
tr2.css("height",_x46);
tr3.css("height",_x46);
}*/
...
dc.body1.add(dc.body2).add(dc.body3).prepend("<table class=\"datagrid-btable datagrid-btable-frozen\" cellspacing=\"0\" cellpadding=\"0\"></table>");
}
_4e(true);
_4e(false);
_24(_4a);
...
if(_4f==3){
	dc.body3.children("table.datagrid-btable-frozen").append(tr);
}else{
...
var _58=$("<div class=\"datagrid-wrap\">"+"<div class=\"datagrid-view\">"+"<div class=\"datagrid-view0\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view1\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\">"+"<div class=\"datagrid-body-inner\"></div>"+"</div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"<div class=\"datagrid-view2\">"+"<div class=\"datagrid-header\">"+"<div class=\"datagrid-header-inner\"></div>"+"</div>"+"<div class=\"datagrid-body\"></div>"+"<div class=\"datagrid-footer\">"+"<div class=\"datagrid-footer-inner\"></div>"+"</div>"+"</div>"+"</div>"+"</div>").insertAfter(_52);
_58.panel({doSize:false,cls:"datagrid"});

_58.parent().find(".datagrid-view").after("<div class='m-scroll'><div class='m-scroll-item'></div></div>")
...
var _vw0=_59.children("div.datagrid-view0");
return {
	panel:_58,
	frozenColumns:cc[0],
	columns:cc[1],
	dc:{view:_59,
		...
		header3:_vw0.children("div.datagrid-header").children("div.datagrid-header-inner"),

		body1:_5a.children("div.datagrid-body").children("div.datagrid-body-inner"),
		body2:_5b.children("div.datagrid-body"),
		body3:_vw0.children("div.datagrid-body").children("div.datagrid-body-inner"),
		...
		footer3:_vw0.children("div.datagrid-footer").children("div.datagrid-footer-inner")
		}
	};
};
function _5c(_5d){
...
_63(dc.header3,_5f.frozenColumnsLeft,true);
_63(dc.header2,_5f.columns,false);

_64();
dc.header1.add(dc.header2).add(dc.header3).css("display",_5f.showHeader?"block":"none");
dc.footer1.add(dc.footer2).add(dc.footer3).css("display",_5f.showFooter?"block":"none");
...
if(col.field){
td.attr("field",col.field);
td.append("<div class=\"datagrid-cell cs_noselect\"><span></span><span class=\"datagrid-sort-icon\"></span></div>");
...
function _64(){
var _73=[];
var _74=_75(_5d,true).concat(_75(_5d)).concat(_75(_5d,3));
...
var _7b=_79.options;
var dc=_79.dc;
var _7c=dc.header1.add(dc.header2).add(dc.header3);
...
var bb=dc.body1.add(dc.body2).add(dc.body3);
bb.unbind();
...
var b3=dc.view3.children("div.datagrid-body");



b1.scrollTop($(this).scrollTop());
b3.scrollTop($(this).scrollTop());
...
$.extend(_aa,_ab);
var dc=_a9.dc;
var _b1=dc.header1.add(dc.header2).add(dc.header3);
...
function _b9(fit){
var _c7=dc.header1.add(dc.header2).add(dc.header3).find(".datagrid-cell-group");
if(_c7.length){
_c7.each(function(){
...
$(".m-scroll-item").width($(".datagrid-view2 .datagrid-btable").outerWidth())
...
var dc=_101.dc;
dc.header1.add(dc.header2).add(dc.header3).find("input[type=checkbox]")._propAttr("checked",false);
if(opts.idField){
...
var dc=_133.dc;
dc.header1.add(dc.header2).add(dc.header3).find("input[type=checkbox]")._propAttr("checked",true);
}
if(opts.idField){
...
var dc=_137.dc;
var _138=dc.header1.add(dc.header2).add(dc.header3);
...
var dc=_13b.dc;
var hck=dc.header1.add(dc.header2).add(dc.header3).find("input[type=checkbox]");
...
opts.frozenColumnsLeft=$.extend(true,[],opts.frozenColumnsLeft);
...
opts.view.renderFooter.call(opts.view,this,dc.footer3,3);
...
$(_1f4)[0].innerHTML=(this.renderTable(_1f3,0,rows,_1f5));
...
var _204=_1fe.rowIdPrefix+"-"+(_tt)+"-"+_1fc;
...
$.ajax({type:opts.method,url:opts.url,contentType: 'application/json; charset=utf-8',data:JSON.stringify(_23d),dataType:"json",success:function(data){
_23e(data);
},error:function(){
...
var tr3=opts.finder.getTr(_240,_241,type,3);
...
if(!tr.length){
	...
	if(_242==3){
		tr=(dc.body3).find(">table>tbody>tr[datagrid-row-index="+_241+"]");
	}else{
...
if(type=="footer"){
	if(_242==3){
		return (dc.footer3).find(">table>tbody>tr[datagrid-row-index="+_241+"]");
	}else{
...
if(type=="selected"){
			if(_242==3){
		return (dc.body3).find(">table>tbody>tr.datagrid-row-selected");
	}else{
...
if(type=="highlight"){
	...
	if(_242==3){
		return (dc.body3).find(">table>tbody>tr.datagrid-row-over");
	}else{
...
if(type=="checked"){
if(_242==3){
		return (dc.body3).find(">table>tbody>tr.datagrid-row-checked");
	}else{
...
if(type=="editing"){
if(_242==3){
		return (dc.body3).find(">table>tbody>tr.datagrid-row-editing");
	}else{
...
if(type=="last"){
	...
	if(_242==3){
		return (dc.body3).find(">table>tbody>tr[datagrid-row-index]:last");
	}else{
...
if(type=="allbody"){
if(_242==3){
		return (dc.body3).find(">table>tbody>tr[datagrid-row-index]");
	}else{
...
if(type=="allfooter"){
if(_242==3){
		return (dc.footer3).find(">table>tbody>tr[datagrid-row-index]");
	}else{
