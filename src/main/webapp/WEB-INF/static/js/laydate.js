    ...
    C.prototype = [], C.prototype.constructor = C, w.extend = function() {
        ...
        if (t.zIndex && (i.style.zIndex = t.zIndex), w.each(new Array(2), function(e) {
                ...
                var a = w.elem("div", {
                    ...
                    i = [function() {
                        var e = w.elem("i", {
                            "class": "layui-icon laydate-icon laydate-prev-y icon iconfont icon-zuo-"
                        });
                        return e.innerHTML = "", e
                    }(), function() {
                        var e = w.elem("i", {
                            "class": "layui-icon laydate-icon laydate-prev-m icon iconfont icon-shangxiazuoyou-3"
                        });
                        return e.innerHTML = "", e
                    }(), function() {
                        var e = w.elem("div", {
                        ...
                        var e = w.elem("i", {
                            "class": "layui-icon laydate-icon laydate-next-m icon iconfont icon-shangxiazuoyou-"
                        });
                        return e.innerHTML = "", e
                    }(), function() {
                        var e = w.elem("i", {
                            "class": "layui-icon laydate-icon laydate-next-y icon iconfont icon-you-"
                        });
                        return e.innerHTML = "", e
                    }()],
                    d = w.elem("div", {
